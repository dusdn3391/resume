...
export const PROJECT_DETAILS: Record<string, ProjectDetail> = {
  ...
  eduops: {
    title: "EduOps",
    subtitle: "학원 운영 통합 관리 웹 서비스",
    tech: ["Next.js 16", "NestJS", "PostgreSQL", "Redis", "Prisma"],
    role: "기획 및 개발 (프론트엔드)", // ← 실제 역할 확인 필요
    year: 2026,
    images: [
      "/images/eduops/6.JPG",
      "/images/eduops/1.JPG",
    ...
    architecture: "/images/eduops/eduops.JPG",
    overview:
      "학생·강사·수업·출결·성적·급여·비품·결재까지 학원 운영 업무 전반을 한 곳에서 처리하는 웹 서비스입니다. 원장, 관리자, 강사 세 가지 역할별로 접근 가능한 화면을 분리해, 각자 자신의 업무에 맞는 화면만 보며 일할 수 있도록 구성했습니다.",

    problems: [
      {
        title: "역할별 접근 권한 분리",
        problem:
          "원장·관리자·강사가 하나의 시스템을 함께 사용하지만, 역할에 따라 접근 가능한 메뉴와 데이터 범위가 달라야 했습니다.",
        solution:
          "JWT 기반 인증에 역할(Role) 정보를 포함시키고, 로그인 시 역할에 맞는 첫 화면으로 자동 이동하도록 라우팅을 구성했습니다. 권한이 없는 페이지는 접근 자체가 차단되도록 처리했습니다.",
      },
      {
        title: "비품 신청-결재 승인 플로우 구현",
        problem:
          "관리자가 올린 비품 신청을 원장이 승인 또는 반려(사유 입력 포함)할 수 있어야 했고, 상태 변경이 양쪽 화면에 정확히 반영되어야 했습니다.",
        solution:
          "신청 상태(대기/승인/반려)를 DB에 저장하고, 반려 시 사유를 함께 기록하도록 스키마를 설계했습니다. TanStack Query로 상태 변경 후 관련 목록을 자동 갱신해 실시간성을 확보했습니다.",
      },
    ],
  },
};

...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tech: ["C#", "WinForms", "Supabase", "Google Vision API", "OCR"],
    live: "",
  ...
  },
  {
    ...
    tech: ["NestJS", "Prisma", "PostgreSQL", "JWT", "Supabase"],
    live: "",
  ...
  },
  {
    ...
    name: "EduOps",
    emoji: "🏫",
    desc: "학생·강사·수업·출결·성적·급여·비품·결재까지 학원 운영 업무를 한 곳에서 처리하는 학원 운영 관리 웹 서비스.",
    tech: ["Next.js", "TypeScript", "NestJS", "Prisma", "PostgreSQL"],
    live: "https://eduops.duckdns.org",
    github: "",
    highlight: "#fde2e2",
  },
];

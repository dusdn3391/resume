...
import { SKILLS_FE, SKILLS_BE, SKILLS_ETC, SKILLS_DB } from "../data/skills";
      ...
      <div className={styles.aboutWrap}>
        <div className={styles.aboutIntro}>
          ...
          <p className={styles.aboutText}>
            2023년 독학으로 시작해, 부트캠프를 거쳐 회사에서 풀스택 개발자로
            일을 하였습니다. 아직 배울 게 많다는 걸 알고 있기 때문에, 많은 것을
            배우고 성정해 나아가는 개발자입니다.
          </p>
          <p className={styles.aboutText}>
            프론트엔드 UI/UX부터 백엔드 API 설계, DB 모델링까지 혼자 한 사이클을
            돌릴 수 있는 개발자가 되고 싶습니다.
          </p>

      ...
      <section className={styles.hero}>
        <div className={styles.heroLeft}>
          ...
          <p className={styles.heroDesc}>
            프론트엔드부터 백엔드까지, <strong>서비스 전체</strong>를 만들 수
            있는 풀스택 개발자입니다. 사용자 경험과 코드 품질 둘 다 놓치지
            않으려 노력합니다.
          </p>
        ...
        <div className={styles.aboutWrap}>
          <div className={styles.aboutIntro}>
            ...
            <p className={styles.aboutText}>
              2023년 독학으로 시작해, 부트캠프를 거쳐 현재 스타트업에서 풀스택
              개발자로 일하고 있습니다. 아직 배울 게 많다는 걸 알지만, 그래서
              매일이 성장하는 기분입니다.
            </p>
            <p className={styles.aboutText}>
              프론트엔드 UI/UX부터 백엔드 API 설계, DB 모델링까지 혼자 한
              사이클을 돌릴 수 있는 개발자가 되고 싶습니다.
            </p>
            <div className={styles.aboutSocial}>
              <a
                href="https://github.com/dusdn3391"
                target="_blank"
            ...
            <div key={i} className={styles.tlItem}>
              ...
              <div className={styles.tlRight}>
                ...
                <div className={styles.tlTags}>
                  {c.tags.map((t) => (
                    <span key={t} className={styles.tlTag}>
                      {t}
                    </span>
                  ))}
                </div>
        ...
        <div className={styles.portfolioBox}>
          <div className={styles.pbLeft}>
            ...
            <p className={styles.pbDesc}>
              Next.js 14 App Router + CSS Modules + TypeScript로 직접
              설계·제작했습니다.
            </p>
          </div>

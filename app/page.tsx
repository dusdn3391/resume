...
>
  경력 보기
        ...
        <div className={styles.heroRight}>
          ...
          <div className={styles.avatarCard}>
            <div className={styles.avatarCircle}>
              <svg viewBox="0 0 80 80" width="80" height="80" fill="none">
                <circle cx="40" cy="30" r="16" fill="#c7d2fe" />
                <ellipse cx="40" cy="64" rx="24" ry="14" fill="#c7d2fe" />
              </svg>
            </div>
            <div className={styles.avatarInfo}>
              <span className={styles.avatarName}>준주니어</span>
              <span className={styles.avatarTitle}>Fullstack Developer</span>
              <div className={styles.avatarBadges}>
                <span className={styles.badge} style={{background:'#e0e7ff',color:'#4338ca'}}>React</span>
          ...
          {/* Floating stickers */}
          <div className={styles.stickerA}>
            <span>🖥 Frontend</span>
          </div>
          <div className={styles.stickerB}>
            <span>⚙️ Backend</span>
          </div>
          <div className={styles.stickerC}>
            <span>🚀 Deploy</span>
          </div>
          ...
          <div className={styles.skillsWrap}>
            <div className={styles.skillCol}>
              <h4 className={styles.skillColTitle}>
                <span className={styles.skillDot} style={{background:'#818cf8'}} />
                Frontend
              </h4>
            ...
            <div className={styles.skillCol}>
              <h4 className={styles.skillColTitle}>
                <span className={styles.skillDot} style={{background:'#34d399'}} />
                Backend
              </h4>
              <ul className={styles.skillList}>
            ...
            <div className={styles.skillCol}>
              <h4 className={styles.skillColTitle}>
                <span className={styles.skillDot} style={{background:'#fbbf24'}} />
                DevOps & Tools
              </h4>
              <ul className={styles.skillList}>
...
<section id="projects" className={styles.section}>
  ...
  <div className={styles.portfolioBox}>
    <div className={styles.pbLeft}>
      ...
      <h3 className={styles.pbTitle}>
        지금 보고 계신 이 사이트!
      </h3>

      <p className={styles.pbDesc}>
        Next.js 14 App Router + CSS Modules + TypeScript로
        직접 설계·제작했습니다.
      </p>
    </div>
    ...
    <div className={styles.pbRight}>
      <div className={styles.pbUrl}>
        <span className={styles.pbUrlProtocol}>
          https://
        </span>

        <span className={styles.pbUrlDomain}>
          junjunior.vercel.app
        </span>
      </div>
